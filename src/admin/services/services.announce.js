...
function announceService(APP_CONFIG, httpSvc) {
    return {
        ...
        putSystemNotice: putSystemNotice
    };
    ...
    //获取站点下拉
    function getSite() {
        return httpSvc.get(APP_CONFIG.apiUrls.ARREARS_SITE, {
    ...
    //开启关闭
    function disbale(postData) {
        return httpSvc.put(APP_CONFIG.apiUrls.SYSTEM_NOTICE_STATE, postData)
            .then(getDataComplete)
            .catch(getDataFailed);
    ...
    function putSystemNotice(postData) {
        return httpSvc.put(APP_CONFIG.apiUrls.PUT_SYSTEM_NOTICE, postData)
            .then(getDataComplete)
            .catch(getDataFailed);
